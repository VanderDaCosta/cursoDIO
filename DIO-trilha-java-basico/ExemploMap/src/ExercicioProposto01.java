...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        System.out.println("Crie um dicionário que relaciona os estados e suas respectivas populações: ");
        Map<String, Integer> populacaoEstados = new HashMap<String, Integer>(){{
            put("PE" , 9616621);
            put("AL" , 3351543);
            put("CE" , 9187103);
            put("RN" , 3534265);
        ...
        System.out.println("Substitua a população do estado de RN por: 3534165");
        ...
        Map<String, Integer> populacaoEstados2 = new LinkedHashMap<String, Integer>(){{
            put("PE" , 9616621);
            put("AL" , 3351543);
            put("CE" , 9187103);
            put("RN" , 3534265);
        ...
        Map<String, Integer> populacaoEstados3 = new TreeMap<>(populacaoEstados);
...
*/
        ...
        System.out.println("Confira se a lista está vazia: " + populacaoEstados.isEmpty());
